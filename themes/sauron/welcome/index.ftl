...
<html>
<head>
    <title>Bienvenido a ${productNameFull}</title>
  ...
  <div class="row">
    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
      <div class="welcome-header">
        ...
        <h1>Bienvenido a <strong>${productNameFull}</strong></h1>
      </div>
      <div class="row">
        <div class="col-xs-12 col-sm-4">
          <div class="card-pf h-l">
            ...
            <#elseif bootstrap>
                <#if localUser>
                    <h3><img src="welcome-content/user.png">Consola de administración</h3>
                    <p>Cree el usuario administración inicial</p>
                <#else>
                    <p class="welcome-message">
                        <img src="welcome-content/alert.png">Para crear el administrador inicial necesita acceso local <br><br>Open <a href="http://localhost:8080/auth">http://localhost:8080/auth</a>
                        <br>o usar el add-user-keycloak script.
                    </p>
                </#if>
            </#if>
            ...
            <div class="welcome-primary-link">
              <h3><a href="${adminUrl}"><img src="welcome-content/user.png">Consola de administración <i class="fa fa-angle-right link" aria-hidden="true"></i></a></h3>
              <div class="description">
                Manejar todos los aspectos del ${productNameFull} server
              </div>
            </div>
          </div>
        </div>
        <div class="col-xs-12 col-sm-4">
          <div class="card-pf h-l">
            ...
            <div class="description">
              ...
              Guias de uso, Admin REST API y Javadocs
        ...
        <#if properties.displayCommunityLinks = "true">
          <div class="card-pf h-m">
            <h3><a href="http://www.keycloak.org"><img src="welcome-content/keycloak-project.png">Proyecto Keycloak <i class="fa fa-angle-right link" aria-hidden="true"></i></a></h3>
          </div>
          <div class="card-pf h-m">
